...
import { EpisodeDetailComponent } from "./shows/episode-detail.component";
...
@NgModule({
    ...
    declarations: [AppComponent, ShowComponent, TopNavigationComponent,
        UserShowsComponent, PageNotFoundComponent, AddShowComponent, FadingCircleComponent, EpisodeDetailComponent, UpcomingShowsComponent],
